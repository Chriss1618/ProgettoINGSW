...
public class MenuViewFactory implements IViewFactory {
    ...
    static {
        classMap.put(ControlMapper.IndexViewMapper.INDEX_MENU_LIST_CATEGORY,  Fragment_ListCategory.class);
        classMap.put(ControlMapper.IndexViewMapper.INDEX_MENU_LIST_PRODUCTS,  Fragment_ListProducts.class);
        classMap.put(ControlMapper.IndexViewMapper.INDEX_MENU_INFO_PRODUCT,   Fragment_InfoProduct.class);
        classMap.put(ControlMapper.IndexViewMapper.INDEX_MENU_NEW_PRODUCT,    Fragment_NewProduct.class);
        classMap.put(ControlMapper.IndexViewMapper.INDEX_MENU_EDIT_PRODUCT,   Fragment_EditProduct.class);
    }
